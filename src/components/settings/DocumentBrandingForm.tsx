...
import { fileToBase64DataUrl, resizeImageToBase64 } from '@/lib/docx-engine/shared'
...
interface DocumentBrandingFormProps {
  onSaved?: () => void
}

export default function DocumentBrandingForm({ onSaved }: DocumentBrandingFormProps) {
