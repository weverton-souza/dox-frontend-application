...
type ButtonVariant = 'primary' | 'secondary' | 'danger' | 'soft-danger' | 'ghost'
...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  'soft-danger': 'bg-red-50 text-red-700 border border-red-200 hover:bg-red-100 active:bg-red-200',
