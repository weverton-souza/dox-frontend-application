...
interface TemplatePickerProps<T extends BaseTemplate> {
  title: string
  emptyLabel: string
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      >
        ...
        <div>
          <p className="font-medium text-gray-900 text-sm">{emptyLabel}</p>
                ...
                {tpls.map(tpl => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-400 mt-1">{renderDetail(tpl)}</p>
                    </div>
                  </button>
                ))}
              </div>
