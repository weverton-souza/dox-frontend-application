...
export default function SectionSidebar({
  ...
  return (
    <aside className="w-full lg:w-72 xl:w-80 lg:shrink-0 flex flex-col lg:self-start lg:sticky lg:top-28 lg:min-h-[600px] lg:max-h-[calc(100vh-8rem)] bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
