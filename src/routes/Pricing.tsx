...
export default function Pricing() {
  ...
  function handleSelect(bundle: Bundle, selectedCycle: PricingCycle) {
      ...
      <header className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="max-w-2xl text-sm text-gray-600">
            Escolha o plano que faz sentido pra sua prática. Você pode trocar
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-gray-300 bg-gray-50 px-6 py-16 text-center">
          ...
          <p className="mt-1 max-w-md text-sm text-gray-600">
            Os bundles ainda não foram configurados. Entre em contato com o
